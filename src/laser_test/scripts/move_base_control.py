...
class MoveBase:
    ...
    def GPIO_setup(self):
        ...
        self.pwm1 = GPIO.PWM(self.M1_PWM, 100)   # 50Hz
        self.pwm1.start(0)
        ...
        self.pwm2 = GPIO.PWM(self.M2_PWM, 100)   # 50Hz
        self.pwm2.start(0)
    ...
    def move(self, M1_speed, M2_speed):
        ...
        self.pwm1.ChangeDutyCycle(abs(M1_speed))
        self.pwm2.ChangeDutyCycle(abs(M2_speed))
